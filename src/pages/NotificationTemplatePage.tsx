...
export default function NotificationTemplatePage() {
  ...
  if (loading) {
    return (
      <div className="px-4 lg:px-8 pt-4 space-y-5">
        <div className="h-8 w-48 rounded-xl bg-gray-100 dark:bg-white/[0.04] animate-pulse" />
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-5">
          <div className="h-80 rounded-2xl bg-gray-100 dark:bg-white/[0.04] animate-pulse" />
          <div className="space-y-4">
            <div className="h-20 rounded-2xl bg-gray-100 dark:bg-white/[0.04] animate-pulse" />
            <div className="h-96 rounded-2xl bg-gray-100 dark:bg-white/[0.04] animate-pulse" />
          </div>
        </div>
      </div>
    )
            ...
            {viewMode === 'edit' ? (
              ...
              >
                ...
                <div className={`${glassCard} p-5 space-y-3`}>
                  ...
                  />
                  {asunto && /{{[^}]+}}/.test(asunto) && (
                    <div className="text-sm font-mono leading-relaxed text-gray-600 dark:text-gray-400 px-1">
                      <span className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-600 mr-2">Preview:</span>
                      <HighlightedText text={asunto} />
                    </div>
                  )}
                </div>
