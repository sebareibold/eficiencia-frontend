...
const NAV_TABS: { label: string; to: string; module: PermModule; icon: React.ComponentType<{ size?: number; className?: string }>; profesorOnly?: boolean }[] = [
  ...
  { label: 'Mis Turnos',   to: ROUTES.MIS_TURNOS,   module: 'solicitudes-turno', icon: CalendarDays, profesorOnly: true },
...
export default function Navbar() {
  ...
  const visibleTabs = NAV_TABS.filter(t => {
    if (t.profesorOnly && user?.role !== 'profesor') return false
